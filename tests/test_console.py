...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittest for testing prompting of the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittest for testing create from the HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittest for testing destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittest for testing all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittest for testing update from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittest for testing count method of HBNB comand interpreter."""
